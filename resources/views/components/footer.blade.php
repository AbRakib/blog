<footer id="subscribe" class="bg-gray-100 border border-black border-opacity-5 rounded-xl text-center py-16 px-10 mt-16">
    <img src="{{ asset('images/avatar.png') }}" alt="" class="mx-auto mb-6" style="width: 145px;">
        ...
        <div class="relative inline-block mx-auto lg:bg-gray-200 rounded-full">
            ...
            <form method="POST" action="{{route('newsletter')}}" class="lg:flex text-sm">
                ...
                <div class="lg:py-3 lg:px-5 flex items-center">
                    ...
                    <input id="email" name="email" type="text" placeholder="Your email address" class="lg:bg-transparent py-2 lg:py-0 pl-4 focus-within:outline-none @error('email') is-invalid @enderror">
                    @error('email')
