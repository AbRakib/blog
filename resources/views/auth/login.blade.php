...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 bg-gray-200 border-gray-800 p-6 rounded sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="{{ route('check.login') }}" method="POST">
        @csrf
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        ...
        <a href="{{route('register')}}" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Let's sing up account</a>
      </p>
    </div>
